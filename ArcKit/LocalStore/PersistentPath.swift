...
open class PersistentPath: Path, PersistentObject {
    ...
    open func insert(in db: Database) throws {
        ...
        try db.execute("""
            ...
            """, arguments: [
                itemId.uuidString, transactionDate, false, deleted, previousItemId?.uuidString, nextItemId?.uuidString,
    ...
    open func update(in db: Database) throws {
        ...
        try db.execute("""
            ...
            WHERE itemId = ?
            """, arguments: [
                transactionDate, false, deleted, previousItemId?.uuidString, nextItemId?.uuidString, _dateRange?.start,
